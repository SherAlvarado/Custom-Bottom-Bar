    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeLayout.setOnClickListener {
            if (selectedTab != 1) {
                ...
                val scaleAnimation = ScaleAnimation(0.8f, 1.0f, 1f, 1f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f).apply {
                    duration = 200
                    fillAfter = true
                }
        ...
        likeLayout.setOnClickListener {
            if (selectedTab != 2) {
                ...
                val scaleAnimation = ScaleAnimation(0.8f, 1.0f, 1f, 1f, Animation.RELATIVE_TO_SELF, 1.0f, Animation.RELATIVE_TO_SELF, 0.0f).apply {
                    duration = 200
                    fillAfter = true
                }
